...
/////
	...
	public void modifyPhoneNumber2(){
		Scanner in = new Scanner(System.in);
		System.out.println("Edit phone number...\n");
		phoneNumber = in.nextInt();
		System.out.println("You have edited the student's phone numer to " + phoneNumber);
	...
	public void modifyPhoneNumber3(){
		Scanner in = new Scanner(System.in);
		System.out.println("Edit phone number...\n");
		phoneNumber = in.nextInt();
		System.out.println("You have edited the student's phone numer to " + phoneNumber);
...
public class students {
	...
	public static void student2() {
		...
		if( modifyField == 1){
			st2.modifyFirstName2();
		}
		if( modifyField == 2){
			st2.modifyLastName2();
		}
		if( modifyField == 3){
			st2.modifyGradeLevel2();
		}
		if( modifyField == 4){
			st2.modifyStudentID2();
		}
		if( modifyField == 5){
			st2.modifyPhoneNumber2();
		}
		if( modifyField == 6){
			st2.modifyAddress2();
		}
	...
	public static void student3() {
		...
		if( modifyField == 1){
			st3.modifyFirstName3();
		}
		if( modifyField == 2){
			st3.modifyLastName3();
		}
		if( modifyField == 3){
			st3.modifyGradeLevel3();
		}
		if( modifyField == 4){
			st3.modifyStudentID3();
		}
		if( modifyField == 5){
			st3.modifyPhoneNumber3();
		}
		if( modifyField == 6){
			st3.modifyAddress3();
		}
