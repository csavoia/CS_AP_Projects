		...
		while(true){
			...
			while(menuOption == 1){
				...
				if(fundsOption == 1){
					...
					accountType[0].withdraw(withdrawValue);
					System.out.println("Your new balance is: $" + accountType[0].balance);
				}
				if(fundsOption == 2){
					System.out.println("How much would you like to deposit?");
					int depositValue = in.nextInt();
					accountType[0].deposit(depositValue);		
					System.out.println("Your new balance is: $" + accountType[0].balance);
				}
			...
			if(menuOption == 2){
				...
				if(fundsOption == 1){
					System.out.println("How much would you like to withdraw?");
					int withdrawValue = in.nextInt();
					accountType[1].withdraw(withdrawValue);
					System.out.println("Your new balance is: $" + accountType[1].balance);
				}
				if(fundsOption == 2){
					System.out.println("How much would you like to deposit?");
					int depositValue = in.nextInt();
					accountType[1].deposit(depositValue);		
					System.out.println("Your new balance is: $" + accountType[1].balance);
				}
			...
			if(menuOption == 3){
				...
				if(fundsOption == 1){
					System.out.println("How much would you like to withdraw?");
					int withdrawValue = in.nextInt();
					accountType[2].withdraw(withdrawValue);
					System.out.println("Your new balance is: $" + accountType[2].balance);
				}
				if(fundsOption == 2){
					System.out.println("How much would you like to deposit?");
					int depositValue = in.nextInt();
					accountType[2].deposit(depositValue);		
					System.out.println("Your new balance is: $" + accountType[2].balance);
				}
			}
		}
